...
class ProviderDetailsScreen extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => _openMapView(context, provider),
            tooltip: 'View on Map',
          ),
        ],
      ),
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _getServiceColor(provider.type).withOpacity(0.1),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      ...
                      'Address',
                      provider.address,
                      onTap: () => _openMapView(context, provider),
                    ),
                  ],
                ),
              ),
  ...
  // Open map view for this provider
  void _openMapView(BuildContext context, Provider provider) {
    Navigator.pushNamed(
      context,
      '/map',
      arguments: {
