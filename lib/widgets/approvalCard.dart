...
//   @override
//   Widget build(BuildContext context) {
//     // 1. Logic to make it disappear if completed or rejected
//     if (request.status == 'completed' || offer.status == 'rejected') {
...
//                 _buildProviderRow(isWinner),
//                 if (isWinner) _buildCompactVerificationCode(context),
//                 if (isWaiting && request.status == 'pending') _buildCompactActionButtons(),
//               ],
//             ),
//           ),
//         ],
...
//           children: [
//             Icon(Icons.lock_outline, size: 14, color: Colors.green.shade800),
